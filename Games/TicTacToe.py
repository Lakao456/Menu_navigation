...
def TicTacToe():
    ...
    label = Label(upper_frame, text="Player 1 (X):", font=('Autobus Bold', 30), bg='#66B933', fg='white', height=1,
                  width=8)
    label.place(relx=0, rely=0, relwidth=0.4, relheight=0.5)

    label = Label(upper_frame, text="Player 2 (O):", font=('Autobus Bold', 30), bg='#66B933', fg='white', height=1,
                  width=8)
